...
Void PlayState_obj::create( ){
{
		...
		HX_STACK_LINE(21)
		background->makeGraphic((int)648,(int)480,(int)-65536,null(),null());
		HX_STACK_LINE(22)
		this->add(background);
		HX_STACK_LINE(23)
		this->super::create();
...
{
		HX_STACK_FRAME("PlayState","destroy",0x6ec756e9,"PlayState.destroy","PlayState.hx",32,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(32)
		this->super::destroy();
	}
...
{
		HX_STACK_FRAME("PlayState","update",0x8d182efa,"PlayState.update","PlayState.hx",40,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(40)
		this->super::update();
	}
